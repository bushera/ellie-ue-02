import { CalExtension, bkingrescheduleExtension, BookingDashboardExtension, BookingDashboardByEmailExtension, QuoteFormExtension, ProjectDashboardExtension, DisableInputExtension} from './extensions.js';
...
(function(d, t) {
  ...
  // Wait for userIdentified event before loading Voiceflow
    ...
    window.voiceflow.chat.load({
      verify: { projectID: '6872a9bb4da28fed25f981e4' },
      ...
      assistant: {
        ...
        extensions: [CalExtension, bkingrescheduleExtension, BookingDashboardExtension, BookingDashboardByEmailExtension, QuoteFormExtension, ProjectDashboardExtension, DisableInputExtension],
      },
      voice: {
